...
#${WRAPPER_ID}{
  ...
  --hoc-accent:#d80000;--hoc-accent-hover:#fc0000;--hoc-accent-text:#fff;
...
.hoc-qris-box .qris-amount-btn.active,.hoc-qris-box .qris-amount-btn:hover{
  background:linear-gradient(to right,#db1a1a 0%,#470a0a 100%);color:var(--hoc-accent-text);border-color:#d80000}
...
.hoc-qris-box .qris-submit-btn{width:100%;margin-top:12px;padding:14px;
  background:linear-gradient(to right,#db1a1a 0%,#470a0a 100%);
...
.hoc-qris-box .qris-submit-btn:hover:not(:disabled){
  background:linear-gradient(to right,#470a0a 0%,#db1a1a 100%)}
