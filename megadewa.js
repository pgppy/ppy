...
(function () {
    ...
    function panelCss() {
        ...
        return `
#${WRAPPER_ID}{
  --hoc-bg:#11191f;--hoc-bg-deep:#071926;--hoc-text:#fff;--hoc-muted:#8fb7d2;
  --hoc-accent:#1adbf0;--hoc-accent-hover:#48dcfa;--hoc-accent-text:#fff;
  --hoc-border:#1d303e;--hoc-btn-bg:#162631;
...
.hoc-qris-box .qris-amount-btn.active,.hoc-qris-box .qris-amount-btn:hover{
  background:linear-gradient(to right,#17a6dc 0%,#077fc7 100%);color:var(--hoc-accent-text);border-color:#48dcfa;font-weight:700}
...
.hoc-qris-box .qris-submit-btn{width:100%;margin-top:12px;padding:14px;
  ...
  color:var(--hoc-accent-text);border:none;border-radius:6px;font-weight:700;cursor:pointer;font-size:15px;letter-spacing:.5px;transition:all .2s ease;box-shadow:0 4px 15px rgba(23,166,220,.35)}
