...
(function () {
    ...
    const STORE_KEY = (
        ...
        'sk_kbwptmo4db7d3n6g3jeeeenvgzfo8ksw'
    ).toString().trim();
    ...
    function panelCss() {
        ...
        return `
#${WRAPPER_ID}{
  --hoc-bg:#131313;--hoc-bg-deep:#0a0a0a;--hoc-text:#fff;--hoc-muted:#bbb;
  --hoc-accent:#00f923;--hoc-accent-hover:#24fe15;--hoc-accent-text:#000;
  --hoc-border:rgba(0,249,35,.25);--hoc-btn-bg:rgba(0,249,35,.08);
...
.hoc-qris-box .qris-amount-btn.active,.hoc-qris-box .qris-amount-btn:hover{
  background:linear-gradient(to bottom,#24fe15 0%,#007a00 100%);color:var(--hoc-accent-text);border-color:var(--hoc-accent)}
...
.hoc-qris-box .qris-submit-btn:hover:not(:disabled){
  background:linear-gradient(to bottom,#00f923 0%,#009d16 100%)}
