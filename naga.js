...
(function () {
    ...
    function panelCss() {
        ...
        return `
#${WRAPPER_ID}{
  --hoc-bg:#180226;--hoc-bg-deep:#12021e;--hoc-text:#fff;--hoc-muted:#bdbdbd;
  --hoc-accent:#e4ff23;--hoc-accent-hover:#d6ef20;--hoc-accent-text:#000;
  --hoc-border:#320050;--hoc-btn-bg:#25013b;
...
.hoc-qris-box .qris-amount-btn.active,.hoc-qris-box .qris-amount-btn:hover{
  background:linear-gradient(to right,#e4ff23 0%,#9db20a 100%);color:var(--hoc-accent-text);border-color:#e4ff23;font-weight:700}
...
.hoc-qris-box .qris-submit-btn{width:100%;margin-top:12px;padding:14px;
  background:linear-gradient(to right,#e4ff23 0%,#9db20a 100%);
  color:var(--hoc-accent-text);border:none;border-radius:6px;font-weight:700;cursor:pointer;font-size:15px;letter-spacing:.5px;transition:all .2s ease}
.hoc-qris-box .qris-submit-btn:hover:not(:disabled){
  background:linear-gradient(to right,#9db20a 0%,#e4ff23 100%)}
